...
<div class="wrap">
    ...
    <form method="post" name="gpsnose_options" action="options.php">
        ...
        <fieldset>
            <legend class="screen-reader-text"><span><?php _e('GpsNose App-Key', $this->plugin_name); ?></span></legend>
            <label for="<?php echo $this->plugin_name; ?>-app-key"><?php _e('GpsNose App-Key', $this->plugin_name); ?></label><br>
        ...
        <fieldset>
            <legend class="screen-reader-text"><span><?php echo str_replace("%mashup%", $mashupExample, __('GpsNose Mashup-Name (e.g. %%mashup%)', $this->plugin_name)) ?></span></legend>
            <label for="<?php echo $this->plugin_name; ?>-mashup"><?php echo str_replace("%mashup%", $mashupExample, __('GpsNose Mashup-Name (e.g. %%mashup%)', $this->plugin_name)) ?></label><br>
        ...
        <h3><?php _e("GpsNose CSS", $this->plugin_name)?></h3>
        <fieldset>
            <legend class="screen-reader-text"><span><?php _e("GpsNose CSS", $this->plugin_name)?></span></legend>
